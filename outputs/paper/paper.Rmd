...
One can observe from the map that most severe fire incidents have the building status of normal. It is coherent with the assumption that fire incidents from the kitchen or cooking area are more likely to occur in operating or occupied buildings. In terms of geographical distribution, the fire incidents are spread out in Toronto with no obvious clusters. 
